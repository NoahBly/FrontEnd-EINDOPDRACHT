...
function Deletefollowing() {
    ...
    const following = useAcceptrequest(null,null,`http://localhost:8083/followrequests/profile/${userDetails.profile.id}/following/${followingId}`,null,null,null,null,null,null,null,null,null,token)
